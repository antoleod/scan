...
**2.2 Add Content Security Policy (CSP) for Web Build**
```html
<!-- In dist/index.html after Expo export -->
...
- Already exists in `scripts/inject-pwa.js` but CSP header is missing
- Small addition to existing PWA injection script
