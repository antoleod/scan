...
const styles = StyleSheet.create({
  ...
  formCard: { width: '100%', borderRadius: 14, borderWidth: 1, padding: 16, gap: 16, overflow: 'hidden', elevation: 12, ...Platform.select({ web: { boxShadow: '0px 16px 32px rgba(0,0,0,0.4)' } as object, default: { shadowColor: '#000', shadowOffset: { width: 0, height: 16 }, shadowOpacity: 0.4, shadowRadius: 32 } }) },
