...
export const mainAppStyles = StyleSheet.create({
  ...
  brandBlock: { flexDirection: 'row', alignItems: 'center', gap: 12, flex: 1, minWidth: 0 },
  headerActions: { flexDirection: 'row', alignItems: 'center', gap: 8, minWidth: 0 },
  ...
  card: { borderWidth: 1, borderRadius: 12, padding: 12, marginBottom: 10, width: '100%', maxWidth: '100%', minWidth: 0, overflow: 'hidden' },
  cardContained: {
    overflow: 'hidden',
  },
  captureCard: {
  ...
  listContent: { paddingBottom: 18, width: '100%', minWidth: 0 },
  historyItemHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  footerBtnInner: { alignItems: 'center', justifyContent: 'center', gap: 3 },
  footerIndicator: {
    position: 'absolute',
    top: 0,
    left: '14%',
